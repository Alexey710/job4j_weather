...
public class WeatherControl {
    ...
    @GetMapping(value = "/more_than/{temperature}")
    public Mono<List<Weather>> compare(@PathVariable Integer temperature) {
        return weathers.findByGreatThanTemperature(temperature);
    }

    @GetMapping(value = "/max")
    public Mono<List<Weather>> max() {
        return weathers.findByHighestTemperature();
    }
}
